...
namespace Kata
{
    public class KataStepCertifyLatestTravelExpense : KataStepBase, IKataStep
    {
        private readonly ILogger _logger;
        private readonly IRestClientProvider _restClientProvider;

        public KataStepCertifyLatestTravelExpense(ILogger logger, IRestClientProvider restClientProvider,
        ...
        {
            return kataStepIdentifier == "CertifyLatestTravelExpense";
        }
